<template>
  <div class="city-select">
    ...
    <selector v-model="selectedProvince" name="province" :options="provinces">
    </selector>
    <selector v-model="selectedCity" name="city" :options="cities">
    </selector>
    <selector v-model="selectedBlock" name="block" :options="blocks">
    </selector>
  </div>
</template>
<script>
